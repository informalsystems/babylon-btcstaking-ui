...
export const questions = (coinName: string): Question[] => {
  const questionList = [
    ...
    {
      title: "I dont see my preferred wallet to stake with, how do I proceed?",
      content: `<p>You can visit <a target="_blank" href="https://btcstaking.babylonlabs.io/">Babylon's Staking UI</a>, scroll through finality providers for Informal Systems and stake with us there.</p><a target="_blank" href="https://btcstaking.babylonlabs.io/">https://btcstaking.babylonlabs.io/</a>`,
    },
  ];
